...
```{r ff-example, fig.cap="Flood frequency last 5 years, somewhere in Norway. Light blue areas are flooded once, and dark blue areas are flooded five times.", out.width='100%', echo=FALSE}
knitr::include_graphics("images/floodFreqExample.png")
```
