...
```{r, echo = FALSE}
poll_loc_year <- readRDS("data/cache/poll_loc_year.RDS")
poll_loc_year %>% 
  slice(1:5) %>% 
kableExtra::kbl()
```
...
```{r, echo=FALSE}
semi_loc<-readRDS("data/cache/semi_loc.RDS")
```
...
```{r,eval=FALSE, fig.cap = "Bumblebees in grasslands 2021"}
...
```{r, echo=FALSE}
allBombusGrassland2022<-readRDS("data/cache/allBombusGrassland2022.RDS")
```
...
```{r, echo=FALSE}
bombus_trond_2022<-readRDS("data/cache/bombus_trond_2022.RDS")
```
...
```{r}
exp_bombus_trond<-readRDS("data/cache/exp_bombus_trond.RDS")
```
...
```{r, echo=FALSE}
diffWeights<-readRDS("data/cache/diffWeights.RDS")
diffWeights
```
...
```{r, echo=FALSE}
amountWeights<-readRDS("data/cache/amountWeights.RDS")
amountWeights
```
...
```{r, echo=FALSE}
hInd2022TrondGress<-readRDS("data/cache/hInd2022TrondGress.RDS")
```
...
```{r, echo=FALSE}
biomass_sn<-readRDS("data/cache/biomass_sn.RDS")
```
...
```{r, echo=FALSE}
richness_sn<-readRDS("data/cache/richness_sn.RDS")
```
...
```{r, echo=FALSE}
pollinators_sn<-readRDS("data/cache(pollinators_sn.RDS")
```
...
```{r bombusGressBarplot,eval=FALSE, fig.cap = "Bumblebees in grasslands 2021"}
...
```{r, echo=FALSE}
allBombusGressmark2022<-readRDS("data/cache/allBombusGressmark2022.RDS")
