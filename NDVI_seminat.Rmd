...
```{r ndvi-condition-ndvis, warning=FALSE, fig.cap="NDVI values across semi-natural ecosystem sites in different ecological condition."}
SentinelNDVI.seminat %>%
  filter(year == kartleggingsaar) %>%
...
```{r balanced-data-ndvis, warning=FALSE, message=FALSE, fig.cap="NDVI values across a condition gradient, faceted by six semi natural ecosystem types in five regions in Norway. "}
...
```{r north-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI agains ecosystm condition for five semi-natural ecosystems in Northern Norway."}
...
```{r central-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for five semi-natural ecosystems in Central Norway."}
SentinelNDVI.seminat.train %>%
...
```{r west-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI agains ecosystm condition for five semi-natural ecosystems in W-Norway."}
SentinelNDVI.seminat.train %>%
...
```{r east-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for five semi-natural ecosystems in E-Norway."}
SentinelNDVI.seminat.train %>%
...
```{r south-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for five semi-natural ecosystems in S-Norway."}
SentinelNDVI.seminat.train %>%
...
```{r ndvi-time-series-comparison-ndvis, fig.cap="Comparing the NDVI time series in the three data sets.", fig.height=10}
# plot
allSatNDVI.seminat %>%
...
saveRDS(model.seminat.time.GodTilst.Sent, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.GodTilst.Sent.rds")
saveRDS(model.seminat.time.GodTilst.Modi, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.GodTilst.Modi.rds")
saveRDS(model.seminat.time.GodTilst.Land, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.GodTilst.Land.rds")
```

```{r, include=F}
model.seminat.time.GodTilst.Sent <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.GodTilst.Sent.rds")
model.seminat.time.GodTilst.Modi <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.GodTilst.Modi.rds")
model.seminat.time.GodTilst.Land <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.GodTilst.Land.rds")
```
...
```{r, include=FALSE, eval=F}
saveRDS(model.seminat.time.tilst.T31.Sent, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.tilst.T31.Sent.rds")
saveRDS(model.seminat.time.tilst.T31.Modi, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.tilst.T31.Modi.rds")
saveRDS(model.seminat.time.tilst.T31.Land, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.tilst.T31.Land.rds")
```

```{r, include=F}
model.seminat.time.tilst.T31.Sent <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.tilst.T31.Sent.rds")
model.seminat.time.tilst.T31.Modi <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.tilst.T31.Modi.rds")
model.seminat.time.tilst.T31.Land <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.seminat.time.tilst.T31.Land.rds")
```
