...
```{r central-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI agains ecosystm condition for five semi-natural ecosystems in Central Norway."}
SentinelNDVI.seminat.train %>%
...
```{r east-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI agains ecosystm condition for five semi-natural ecosystems in E-Norway."}
SentinelNDVI.seminat.train %>%
...
```{r  south-nvdi-vs-tilstand-ndvis, message=FALSE, warning=FALSE, fig.cap="NDVI agains ecosystm condition for five semi-natural ecosystems in S-Norway."}
SentinelNDVI.seminat.train %>%
