...
```{r, include = T, results='hide', warning=F, message=F, class.source = 'fold-hide'}
...
```{r ano-sp-tab, class.source = 'fold-hide'}
head(ANO.sp.ind) %>%
...
```{r wetland-ref-data-tab, class.source = 'fold-hide'}
...
```{r, attr.output='style="max-height: 300px;"', results='hide', class.source = 'fold-hide'}
...
```{r fpiw-plot-maintype, message=FALSE, warning=FALSE, fig.cap="Scaled vegetation indicator values for wetlands. 1 = cases where variable is lower than the reference value- 2 = cases where variablei is higher than the reference value.", out.width='100%', class.source = 'fold-hide'}
...
```{r fpiw-plot-maintype-v2, message=FALSE, warning=FALSE, fig.cap="Scaled vegetation indicator values for the four most common sub-types of wetland. 1 = cases where variable is lower than the reference value- 2 = cases where variablei is higher than the reference value.", out.width='100%', class.source = 'fold-hide'}
...
```{r ph-lower-map-fpiw, warning=FALSE, message = FALSE, fig.cap="Functional plant indicator values for pH (lower) in wetlands.", class.source = 'fold-hide'}
#### scaled value maps ####
...
```{r pH-distcomp-fpiw, class.source = 'fold-hide', fig.cap="Comparing the reference and variable distribution for the pH indicator in ecosystem sub-type V1."}
...
```{r ph-distcomp2-fpiw, class.source = 'fold-hide', fig.cap="Comparing the reference and variable distribution for the pH indicator in ecosystem sub-types other than V1."}
par(mfrow=c(2,4))
## V2s
# V2-C-1
...
```{r n-distcomp-fpiw, class.source = 'fold-hide', fig.cap="Comparing the reference and variable distribution for the nitrogen affiliation indicator in ecosystem sub-type V1."}
### Nitrogen
par(mfrow=c(2,4))
## V1s
# V1-C-1
...
```{r n-distcomp2-fpiw,class.source = 'fold-hide', fig.cap="Comparing the reference and variable distribution for the nitrogen affiliation indicator in ecosystem sub-types other than V1."}
par(mfrow=c(2,4))
## V2s
# V2-C-1
