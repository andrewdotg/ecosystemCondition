...
In the analysis in this document, we use the data available on Miljødirektoratets kartkatalog (https://kartkatalog.miljodirektoratet.no/Dataset/Details/2054), which as of today comprises data from the first three ANO-years, 2019-2021, and a total of 8887 plots in 498 sites.
