...
Alternatively I can rasterize the indicator map, and mask it using a perfectly aligned ET map. This might be faster.

### Crop to ET
This is a very heavy operation.
```{r, eval=F}
mireET <- sf::st_read("R:/Kladd/Myr/Myrmodell.gdb")
```
