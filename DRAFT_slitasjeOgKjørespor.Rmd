...
This variable is also recorded in GRUK
...
It could make sense to combine some zones, but I will later split the sones by region, and then merge sones that are very uncommon in a spesific region.
