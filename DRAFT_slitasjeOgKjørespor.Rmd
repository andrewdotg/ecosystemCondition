...
```{rslitasje-box, fig.cap="The relationship between human impact factor (a categorical version of the Norwegian Infrastructure Index) and the indicator avleus for slitasje."}
