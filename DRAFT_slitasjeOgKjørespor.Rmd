...
good predictor for *slitasje*, and I think to use it to define local reference area,
or homogeneous (impact) areas.
...
Here I define a simplified categorical typology for the infrastructure
index using four classes.
...
was in the second lowest class. This looks pretty good to me.
...
I want to use the [homogeneous impact areas]() to define smaller regions into which I can extrapolate the indicator values.

```{r}
HIA <- readRDS("P:/41201785_okologisk_tilstand_2022_2023/data/cache/infra_agg.rds")
```
...
### Homogeneous areas
Export a map of the homogeneous areas that we aggregate the indicator
over:
