...
four impact area classes as their *Human Impact Factor*.
...
I also want to split these four HIA classes based on their region. 

<!-- Add function to ea_homogeneous_area() to find intersection with a decond delinimator -->
