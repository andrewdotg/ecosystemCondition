...
I tweaked the thresholds so that most of the forest next to Trondheim
was i the second lowest class.
...
*homogenous ecological areas*. That's where the infrastructure index
...
```{r, eval=F}
st_write(exp_wetland, "indicators/indicatorMaps/wetland_slitasje.shp",
         append = F)
```
