...
Bakkestuen, V., Dervo, B.K., Bærum, K.M.
og Erikstad, L.
2022.
...
It depicts a gradient in human presence from high within the build zone, to *no to very low* in the forests and mountains to the west.
...
Each cell is no the average of the aggregated cells, and hence the value is continous again.
...
Let's plot this now.
First.
lets crop it to reduce computation time.
...
```{r, eval=F}
saveRDS(infra_agg_discrete_vect_trd, "P:/41201785_okologisk_tilstand_2022_2023/data/infrastrukturindeks/homogeneous_impact_areas.rds")
```
