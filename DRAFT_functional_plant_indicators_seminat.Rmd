...
```
In the ANO data deviations in the grazing/mowing index occur mainly in semi-natural grasslands (T32) on intermediate soils in terms of limestone (C3, C4, C6, C5 [but the latter is one category higher in limestone than intermediate). The deviatons towards low grazing/mowing values indicate that management and use are too extensive.
