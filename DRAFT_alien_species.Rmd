...
```{r slitasje-normalise, fig.cap="Performing a linear break-point type normalisation of the slitasje variable.", fig.width=3}
eaTools::ea_normalise(data = alien_data,
                      vector = "var_7FA",
                      upper_reference_level = upper,
                      lower_reference_level = lower,
