...
Egenskap  <- "Funksjonelt viktige arter og strukturer"
...
2.  take a simplified infrastructure index (vector data) and intersect this with municipality boarders to produce a map of homogeneous impact areas (HIAs).
...
4. Then, look at [Median Summer Temperature] for how to aggregate spatially tp accounting areas (regions)


This workflow should be synchronized with the [slitasje](#slitasje-og-kjørespor) indicator.