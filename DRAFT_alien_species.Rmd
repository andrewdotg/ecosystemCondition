...
Here I base the indicator on the R7 scale, since this is the bigger data set. I therfore convert %cover into R7 classes based on what I can interpret from Fig. \@ref(fig:fremmedart-prosentVSinnslag).
...
```{r fremmedart-prosentVSinnslag, fig.cap="Comparing the R7 scale (x axis) which is used in the nature type monitoring progra with %cover (y-axis), which is how alien species is recorded in ANO."}
