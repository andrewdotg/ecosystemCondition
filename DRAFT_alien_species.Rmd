...
```{r fig.cap="An overview of the naturetypes for which we will calculate the indicator.", fig.height=8, fig.width=4}
...
There are som multisurfaces in here that I will convert to multoipolygons before plotting.
...
inside eaTools (see [GitHub issue](https://github.com/NINAnor/eaTools/issues/15)).
