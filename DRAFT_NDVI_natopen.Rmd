...
We remove T20 from the statistical analyses because this ecosystem type is only ever registerd as in good condition, and it appears only in two regions.
```{r}
SentinelNDVI.natopen <- SentinelNDVI.natopen %>% filter(hovetype != 'T20')
```
