...
```{r, fig.cap="NiN main type across five main ecosystems (Hule eiker, mosaic localities, and localities with >1 NiN main type excluded)"}
ggplot(dat_red)+
  geom_bar(aes(x = ninkartleggingsenheter3),
           fill="grey",
           colour="black")+
...
```{r, fig.cap="Number of localities for each combination of main ecosystem and NiN main type (after data set cleaning)"}
...
```{r, fig.cap="Total mapped are for each combination of main ecosystem and NiN main type (after data set cleaning)"}
...
```{r, fig.cap="An overview of the nature types in the data set", fig.height=15}
