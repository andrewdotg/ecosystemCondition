...
```{r, echo=F}
dat$naturtype[dat$area == max(dat$area)]
```

The smallest polygon is a 
```{r, echo=F}
dat$naturtype[dat$area == min(dat$area)]
```
...
```{r, fig.cap="The ten most common nature types and the number of localities with with multiple NiN main types"}
