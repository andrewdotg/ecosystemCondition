...
```{r, fig.cap="Barplot showing the proportion area for which each NiN variable is recorded. The last letter of the NiN variable code refers to the ecosystem tye, and is not part of the variable name. The total mapped area for each main ecosystem (the facets) is shown as a dashed red line. "}
ntyp_fill2 %>%
