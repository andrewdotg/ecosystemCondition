...
```{r, include=F, eval=F}
saveRDS(nin.natopen, paste0(here::here(), "/data/cache/nin.natopen.RDS"))
saveRDS(nin.natopen2, paste0(here::here(), "/data/cache/nin.natopen2.RDS"))
```
...
```{r where-are-natopen-sites, fig.cap="A map of Norway showing the location of the naturally open ecosystem sites. T12 = coastal meadows, T18 = flood plains, T2 = shallow soils, T20 = innfrysningsmark, T21 = sand dunes."}
tm_shape(regnor) +
...
```{r histogram-sentinall-ndvin, fig.cap="Histogram of naturally open ecosystem polygon sizes in Norway."}
...
```{r NDVI-values-over-time-ndvin, fig.cap="A figure showing NDVI values for naturally open ecosystem over time for six different main nature types in varying degrees of condition.}
...
```{r NDVI-major-ndvin, warning=FALSE, fig.cap="NDVI values in major natopen ecosystem types in good condition."}
SentinelNDVI.natopen %>%
  filter(tilstand == "God") %>%
...
```{r NDVI-basic-ndvin, warning=FALSE, fig.cap="NDVI values in basic natopen ecosystem types in good condition.}
SentinelNDVI.natopen %>%
  filter(tilstand == "God") %>%
  filter(year == kartleggingsaar) %>%
...
```{r ndvi-regions-ndvin, warning=FALSE, fig.cap="DVI variation across regions in natopen ecosystems (major types) in good condition.}
SentinelNDVI.natopen %>%
  filter(tilstand == "God") %>%
  filter(year == kartleggingsaar) %>%
  filter(!is.na(region)) %>%
...
```{r ndvi-condition-ndvin, warning=FALSE, fig.cap="NDVI values across natopen sites in different ecological condition.}
SentinelNDVI.natopen %>%
  filter(year == kartleggingsaar) %>%
...
```{r balanced-data-ndvin, warning=FALSE, message=FALSE, fig.cap="NDVI values across a condition gradient, faceted by natopen ecosystem types in five regions in Norway. ", fig.height=12}
...
**Northern Norway**
```{r north-nvdi-vs-tilstand-ndvin, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for natopen ecosystems in Northern Norway."}
...
**Central Norway**
```{r central-nvdi-vs-tilstand-ndvin, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for natopen ecosystems in Central Norway."}
SentinelNDVI.natopen.train %>%
...
**Western Norway**
```{r west-nvdi-vs-tilstand-ndvin, message=FALSE, warning=FALSE, fig.cap="NDVI agains ecosystm condition for natopen ecosystems in W-Norway."}
SentinelNDVI.natopen.train %>%
...
**Eastern Norway**
```{r east-nvdi-vs-tilstand-ndvin, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for natopen ecosystems in E-Norway."}
SentinelNDVI.natopen.train %>%
...
**Southern Norway**
```{r south-nvdi-vs-tilstand-ndvin, message=FALSE, warning=FALSE, fig.cap="NDVI against ecosystem condition for natopen ecosystems in S-Norway."}
SentinelNDVI.natopen.train %>%
...
```{r ndvi-time-series-comparison-ndvin, fig.cap="Comparing the NDVI time series in the three data sets.", fig.height=10}
# plot
allSatNDVI.natopen %>%
...
```{r, include=F, eval=F}
saveRDS(model.natopen.time.GodTilst.Sent, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.GodTilst.Sent.rds")
saveRDS(model.natopen.time.GodTilst.Land, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.GodTilst.Land.rds")
```

```{r, include=F}
model.natopen.time.GodTilst.Sent <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.GodTilst.Sent.rds")
model.natopen.time.GodTilst.Land <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.GodTilst.Land.rds")
```
...
```{r, eval=F, include=F}
saveRDS(model.natopen.time.tilst.T12.Sent, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T12.Sent.rds")
saveRDS(model.natopen.time.tilst.T12.Land, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T12.Land.rds")
saveRDS(model.natopen.time.tilst.T18.Sent, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T18.Sent.rds")
saveRDS(model.natopen.time.tilst.T18.Land, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T18.Land.rds")
saveRDS(model.natopen.time.tilst.T21.Sent, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T21.Sent.rds")
saveRDS(model.natopen.time.tilst.T21.Land, "/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T21.Land.rds")
```

```{r, include=F}
model.natopen.time.tilst.T12.Sent <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T12.Sent.rds")
model.natopen.time.tilst.T12.Land <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T12.Land.rds")
model.natopen.time.tilst.T18.Sent <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T18.Sent.rds")
model.natopen.time.tilst.T18.Land <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T18.Land.rds")
model.natopen.time.tilst.T21.Sent <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T21.Sent.rds")
model.natopen.time.tilst.T21.Land <- readRDS("/data/P-Prosjekter2/41201785_okologisk_tilstand_2022_2023/data/cache/model.natopen.time.tilst.T21.Land.rds")
```
