...
#| cache: TRUE
#| fig.cap: "Net primary production over Norway"
...
```{r ar50, fig.cap="A view of the AR50 data used as a placeholder for an ecosystem map.", out.width='50%'}
knitr::include_graphics("data/cache/gg1_tlb.png")
```

```{r forestdiff-tlb, fig.cap="Difference in forest herbivore biomass from expectation", out.width='50%'}
knitr::include_graphics("data/cache/gg2_tlb.png")
```

```{r forestcarn-tlb, fig.cap="Difference in forest carnivore biomass from expectation", out.width='50%'}
knitr::include_graphics("data/cache/gg3_tlb.png")
```

```{r forestherbdiff-tlb, fig.cap="Difference in forest herbivore biomass from expectation", out.width='50%'}
knitr::include_graphics("data/cache/gg4_tlb.png")
```

```{r forestcarn2-tlb, fig.cap="Difference in forest carnivore biomass from expectation", out.width='50%'}
...
```{r herbtime, fig.cap="Difference in herbivore biomass from expectations"}
knitr::include_graphics("data/cache/gg6_tlb.png")
```

```{r carntime, fig.cap="Difference in herbivore biomass from expectations"}
