...
```{r dense-stats, fig.height= 12, fig.cap="Barplot showing the number of data points, the area weighted indicator values and the sd for the ADSV indicator. Transparent bars represents categories with less than 150 data points."}
temp_plot <- all_stats %>%
