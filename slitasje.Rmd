...
```{r, warning=F}
naturetypes_wide$slitasje <- apply(naturetypes_wide[,-1], 1, max, na.rm=T)
```

When both variables are NA, we get -Inf. There were 13 cases of this
...
```{r, fig.cap="Counting the number of cases where 7TK or 7SE was defining of the slitasje indicator score.", fig.width=3}


diff <- max(naturetypes_wide$var_7SE, naturetypes_wide$var_PRSL, na.rm=T) - 
        max(naturetypes_wide$var_7TK, naturetypes_wide$var_PRTK, na.rm=T)
