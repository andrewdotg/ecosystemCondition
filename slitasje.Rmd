...
amount-driven). The threshold for good ecosystem condition is set to 10%
damage. 
...
First I will combine 7TK and PRTK, and also 7SE and PRSL using the one-out-all-out principle. This is a more conservative approach than for example simply adding these together, but we do it this way because the two variables are likely to overlap considerably at small spatial scales. 
