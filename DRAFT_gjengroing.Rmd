...
```{r}
include_graphics('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/images/gjengroing_schematic.jpg')
```
...
```{r}
regions <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/regions.shp') %>%
...
```{r}
ssb10km <- st_read('R:/GeoSpatialData/Population_demography/Norway_SSB/Original/ssb_10km/ssb10km.shp')%>%
...
ssb50km <- st_read('R:/GeoSpatialData/Population_demography/Norway_SSB/Original/ssb_50km/ssb50km.shp')%>%
  # mutate the id value so that it aligns with the data coming from GEE
  mutate(SSBID = as.numeric(SSBID)/1000)
# Transform to the correct projection
...
```{r}
bioclim <- st_read('R:/GeoSpatialData/BiogeographicalRegions/Norway_VegetationZones_Moen/Original/Vector/soner.shp') %>%
...
readVegHeightFiles <- function(uniqueString){
  dir <- 'P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/From_GEE/vegHeights/'
...
areaCovers <- read_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/From_GEE/area_cover_grid.csv') %>%
...
elevStrata <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/From_GEE/elevation_stratified.shp') %>%
...
if (runFromScratch){
  ...
  refVaatmark %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/refVaatmark.csv')
  refAapne %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/refAapne.csv')
  ...
  refVaatmark  <- read_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/refVaatmark.csv')
  refAapne <- read_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/refAapne.csv')
...
if (runFromScratch){
  ...
  vaatmarkIndexPolySpat <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/vaatmark_index.shp')%>%
    mutate(`system:index` = id,
           elevation = elev, 
           vegClimZoneLab = vegZn) %>%
    dplyr::select(-id, -elev, -vegZn)
  aapneIndexPolySpat <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/aapne_index.shp')%>%
    mutate(`system:index` = id,
           elevation = elev, 
           vegClimZoneLab = vegZn) %>%
    dplyr::select(-id, -elev, -vegZn)
...
if (runFromScratch){
  ...
  vaatmarkIndexStrata %>% write_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/vaatmarkIndexStrata.csv')
  aapneIndexStrata %>% write_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/aapneIndexStrata.csv')
  

} else {
  
  vaatmarkIndexStrata <- read_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/vaatmarkIndexStrata.csv')
  aapneIndexStrata <- read_csv('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/aapneIndexStrata.csv')
...
if (runFromScratch){
  ...
  vaatmarkIndexGrid <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/vaatmark_index_grid.shp')
  aapneIndexGrid <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/aapne_index_grid.shp')
...
if (runFromScratch){
  ...
  vaatmarkIndexRegion <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/vaatmark_index_region.shp')
  aapneIndexRegion <- st_read('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/aapne_index_region.shp')
...
```{r}
include_graphics('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/images/val_1.jpg')
```
...
```{r}
include_graphics('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/images/val_2.jpg')
```
...
```{r}
include_graphics('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/images/val_3.jpg')
```
...
```{r}
include_graphics('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/images/val_4.jpg')
```
...
```{r}
include_graphics('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/DATA/images/val_5.jpg')
```

### Eksport file (final product)

We will export gjengroing indicator values at three levels:
- polygon level
- 50km grid level
- regional level
...
if (runFromScratch){
  ...
  vaatmarkIndexPolySpat  %>%
    ...
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/vaatmark_index.shp', append=FALSE)
  ...
  aapneIndexPolySpat %>% 
    ...
    mutate(id = `system:index`,
           ...
           vegZn = vegClimZoneLab) %>%
    dplyr::select(-"system:index", -vegClimZoneLab, -elevation) %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/aapne_index.shp', append=FALSE)
  
  # Grid level
  vaatmarkIndexGrid %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/vaatmark_index_grid.shp', append = FALSE)
  aapneIndexGrid %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/aapne_index_grid.shp', append = FALSE)
  
  # Region level
  vaatmarkIndexRegion %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/vaatmark_index_region.shp', append = FALSE)
  aapneIndexRegion %>%
    st_write('P:/41201785_okologisk_tilstand_2022_2023/gjengroing/R_project/OUTPUT/aapne_index_region.shp', append = FALSE)
}
