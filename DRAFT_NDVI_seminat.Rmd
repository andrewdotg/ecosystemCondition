...
summary(as.factor(nin.seminat$id))
nin.seminat[nin.seminat$id=="NINFP2110008060",]
# this one was assigned to both Western and Central Norway, we drop the latter
nin.seminat <- nin.seminat[!row.names(nin.seminat) %in% '1144.1',]
...
model.semi-natural.cond.Sent <- betareg(mean_beta~tilstand_num*region*hovedtype, data=SentinelNDVI.seminat.train)
...
model.semi-natural.cond.Sent.N <- betareg(mean_beta~tilstand_num*hovedtype, data=SentinelNDVI.seminat.train[SentinelNDVI.seminat.train$region=="Northern Norway",])
model.semi-natural.cond.Sent.C <- betareg(mean_beta~tilstand_num*hovedtype, data=SentinelNDVI.seminat.train[SentinelNDVI.seminat.train$region=="Central Norway",])
model.semi-natural.cond.Sent.W <- betareg(mean_beta~tilstand_num*hovedtype, data=SentinelNDVI.seminat.train[SentinelNDVI.seminat.train$region=="Western Norway",])
model.semi-natural.cond.Sent.E <- betareg(mean_beta~tilstand_num*hovedtype, data=SentinelNDVI.seminat.train[SentinelNDVI.seminat.train$region=="Eastern Norway",])
model.semi-natural.cond.Sent.S <- betareg(mean_beta~tilstand_num*hovedtype, data=SentinelNDVI.seminat.train[SentinelNDVI.seminat.train$region=="Southern Norway",])
...
```{r message=FALSE, warning=FALSE}
model.semi-natural.time.GodTilst.Sent <- glmmTMB(mean_beta~year*hovedtype + (1|id), family=beta_family(),data=SentinelNDVI.seminat[SentinelNDVI.seminat$tilstand=="God",])
model.semi-natural.time.GodTilst.Modi <- glmmTMB(mean_beta~year*hovedtype + (1|id), family=beta_family(),data=ModisNDVI.seminat[ModisNDVI.seminat$tilstand=="God",])
model.semi-natural.time.GodTilst.Land <- glmmTMB(mean_beta~year*hovedtype + (1|id), family=beta_family(),data=LandsatNDVI.seminat[LandsatNDVI.seminat$tilstand=="God",])
...
```{r message=FALSE, warning=FALSE}
model.semi-natural.time.tilst.V9V10.Sent <- glmmTMB(mean_beta~year*tilstand + (1|id), family=beta_family(),data=SentinelNDVI.seminat[SentinelNDVI.seminat$hovedtype %in% c("V9","V10"),])
model.semi-natural.time.tilst.V9V10.Modi <- glmmTMB(mean_beta~year*tilstand + (1|id), family=beta_family(),data=ModisNDVI.seminat[ModisNDVI.seminat$hovedtype %in% c("V9","V10"),])
model.semi-natural.time.tilst.V9V10.Land <- glmmTMB(mean_beta~year*tilstand + (1|id), family=beta_family(),data=LandsatNDVI.seminat[LandsatNDVI.seminat$hovedtype %in% c("V9","V10"),])
