---
title: "TrophicLevelBiomassRatios"
...
knitr:
  opts_knit:
    root.dir: "S://R projects//TrophicIntIndicators"
execute: 
  cache: true
---
...
writeRaster(expected_herbivore_biomass,"Vertebrates/outputs/expectedbiomass/expectedherbivorebiomass.tif",overwrite=TRUE)
...
writeRaster(diffherb,"Vertebrates/outputs/HerbivoreBiomassDiffExpected.tif",overwrite=TRUE)
...
writeRaster(expected_carnivore_biomass,"Vertebrates/outputs/expectedbiomass/expectedcarnivorebiomass.tif",overwrite=TRUE)

writeRaster(diffcarn,"Vertebrates/outputs/CarnivoreBiomassDiffExpected.tif",overwrite=TRUE)

```

From the above we see that Norway has had less carnivore biomass than expected based on the availabile herbivore biomass across the time period. Some counties and time periods (e.g. Hedmark today and Finnmark in 1907 had about the same carnivore biomass as predicted.
...
# #Scaling as indicators
 ...
 writeRaster(forest_diffcarn,"Vertebrates/outputs/forest_carnivores_diffexpected.tif",overwrite=TRUE)
 writeRaster(forest_diffherb,"Vertebrates/outputs/forest_herbivores_diffexpected.tif",overwrite=TRUE)
```
