...
model.wetland.train <- betareg(mean_beta~tilstand_num*region*hovedtype, data=SentinelNDVI.wetland.train)
...
It is evident that all three variables matter, for ease of interpretation we run the model separately for every region
```{r}
