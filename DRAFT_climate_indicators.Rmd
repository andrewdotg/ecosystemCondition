...
```{r, fig.cap="Scaled indicator values, aggregated over 5 year intervals. Errors represent spatial variation within regions and across years."}
...
```{r}
ggplot(reg2) + 
  geom_sf(fill = indicator) +
  geom_sf_label(aes(label = indicator))
