...
The reference condition for climate variables is defined as the last normal period 1961-1990.

### Reference values, thresholds for defining *good ecological condition*, minimum and/or maximum values

-   Un-scaled indicator value = median value over 5 year periods
...
```{r, fig.cap="Table explaining the available climate parameters in the data set."}
...
user system elapsed 9.624 6.069 20.903
...
user system elapsed 14.803 2.717 17.512
...
The *real* indicator values should be running means over 5 years, but calculating a running mean for all time steps is too time consuming. Therefore, the time series will be presented with yearly resolution, and the scaled, regional indicator values will be calculated for distinct time steps.
