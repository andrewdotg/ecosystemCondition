...
```{r, echo=F}
Ecosystem <- c("Skog", "fjell", "våtmark", "seminaturlig mark")
Egenskap  <- rep("Biologisk mangfold" , 4)
ECT       <- rep("Compositional state characteristic" , 4)
Contact   <- rep("Chloé R. Nater" , 4)
```
